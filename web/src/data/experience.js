export const experiences =[
    {
        ...
        description: [
            'Designed and implemented the client-side application for Hibiki-AI, leveraging JavaScript to deliver robust user-facing functionality.', 'Built secure, scalable integrations with backend AI services to enable seamless communication between users and the Hibiki-AI platform.', 'Orchestrated modular code structures to support maintainable development and facilitate future feature expansion.', 'Ensured codebase quality and compliance by adhering to the Apache 2.0 license and best practices for private, production-ready repositories.'
        ]
    },
    {
        company: 'YouGov',
